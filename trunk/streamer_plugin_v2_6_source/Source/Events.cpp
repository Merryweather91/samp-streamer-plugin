...
bool Events::OnPlayerConnect(int playerid)
{
	...
	if (p == core->getData()->players.end())
	{
		...
		player.visibleObjects = core->getStreamer()->getOption(Streamer::VisibleItems, STREAMER_TYPE_OBJECT);
		player.visibleTextLabels = core->getStreamer()->getOption(Streamer::VisibleItems, STREAMER_TYPE_3D_TEXT_LABEL);
		player.worldID = 0;
