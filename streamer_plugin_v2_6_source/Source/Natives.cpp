...
cell AMX_NATIVE_CALL Natives::Streamer_MaxItems(AMX *amx, cell *params)
{
	...
	if (!core->getStreamer()->setOption(Streamer::MaxItems, static_cast<int>(params[1]), static_cast<int>(params[2])))
	{
...
cell AMX_NATIVE_CALL Natives::Streamer_VisibleItems(AMX *amx, cell *params)
{
	...
	if (!core->getStreamer()->setOption(Streamer::VisibleItems, static_cast<int>(params[1]), static_cast<int>(params[2])))
	{
		logprintf("*** Streamer_MaxItems: Invalid type specified");
		return 0;
	}
...
cell AMX_NATIVE_CALL Natives::CreateDynamicObject(AMX *amx, cell *params)
{
	...
	if (core->getStreamer()->getOption(Streamer::MaxItems, STREAMER_TYPE_OBJECT) == core->getData()->objects.size())
	{
		return 0;
	}
...
cell AMX_NATIVE_CALL Natives::CreateDynamicPickup(AMX *amx, cell *params)
{
	...
	if (core->getStreamer()->getOption(Streamer::MaxItems, STREAMER_TYPE_PICKUP) == core->getData()->pickups.size())
	{
		return 0;
	}
...
cell AMX_NATIVE_CALL Natives::CreateDynamicCP(AMX *amx, cell *params)
{
	...
	if (core->getStreamer()->getOption(Streamer::MaxItems, STREAMER_TYPE_CP) == core->getData()->checkpoints.size())
	{
		return 0;
	}
...
cell AMX_NATIVE_CALL Natives::CreateDynamicRaceCP(AMX *amx, cell *params)
{
	...
	if (core->getStreamer()->getOption(Streamer::MaxItems, STREAMER_TYPE_RACE_CP) == core->getData()->raceCheckpoints.size())
	{
		return 0;
	}
...
cell AMX_NATIVE_CALL Natives::CreateDynamicMapIcon(AMX *amx, cell *params)
{
	...
	if (core->getStreamer()->getOption(Streamer::MaxItems, STREAMER_TYPE_MAP_ICON) == core->getData()->mapIcons.size())
	{
		return 0;
	}
...
cell AMX_NATIVE_CALL Natives::CreateDynamic3DTextLabel(AMX *amx, cell *params)
{
	...
	if (core->getStreamer()->getOption(Streamer::MaxItems, STREAMER_TYPE_3D_TEXT_LABEL) == core->getData()->textLabels.size())
	{
		return 0;
	}
...
cell AMX_NATIVE_CALL Natives::CreateDynamicCircle(AMX *amx, cell *params)
{
	...
	if (core->getStreamer()->getOption(Streamer::MaxItems, STREAMER_TYPE_AREA) == core->getData()->areas.size())
	{
		return 0;
	}
